...
mod actions {
    ...
    impl ActionsImpl of IActions<ContractState> {
        fn create_player(ref self: ContractState, address: ContractAddress) -> Player {
        ...
        fn create_game(ref self: ContractState, address: ContractAddress) -> Game {
            let world = self.world_dispatcher.read();
        ...
        fn leave(ref self: ContractState, address: ContractAddress, game_id: u128) {
            let world = self.world_dispatcher.read();
        ...
        fn join(ref self: ContractState, address: ContractAddress, game_id: u128) {
            let world = self.world_dispatcher.read();
