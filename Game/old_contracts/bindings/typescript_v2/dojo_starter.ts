// Generated by dojo-bindgen on Sat, 22 Jun 2024 19:19:02 +0000. Do not modify this file manually.
...
type GameState = { type: 'Waiting'; } | { type: 'Lock'; } | { type: 'Running'; } | { type: 'Finish'; }
...
class ActionsCalls extends BaseCalls {
    ...
    async leave(game_id: bigint): Promise<void> {
        try {
    ...
    async join(game_id: bigint): Promise<void> {
        try {
